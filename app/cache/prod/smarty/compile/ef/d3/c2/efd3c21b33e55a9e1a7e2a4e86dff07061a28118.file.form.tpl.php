<?php /* Smarty version Smarty-3.1.19, created on 2017-04-05 11:59:15
         compiled from "/Users/patpbe/Sites/ps1710/admin/themes/default/template/controllers/access/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:23541223258e4bff398a2c3-52409078%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'efd3c21b33e55a9e1a7e2a4e86dff07061a28118' => 
    array (
      0 => '/Users/patpbe/Sites/ps1710/admin/themes/default/template/controllers/access/helpers/form/form.tpl',
      1 => 1490891120,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '23541223258e4bff398a2c3-52409078',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58e4bff3e7cc81_33345455',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58e4bff3e7cc81_33345455')) {function content_58e4bff3e7cc81_33345455($_smarty_tpl) {?>
...
_form" class="defaultForm form-horizontal col-lg-10" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['current']->value,'html','UTF-8');?>
...
">
                           ...
                           <tr>
                              <th></th>
                              <th>
                                 <input type="checkbox" name="1" class="viewall ajaxPower"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="0" data-parent="0" data-type="view" data-rel="-1||<?php echo $_smarty_tpl->tpl_vars['profile']->value['id_profile'];?>
...
"<?php } else { ?> disabled="disabled"<?php }?>/>
                              ...
                              <th>
                                 <input type="checkbox" name="1" class="addall ajaxPower"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="1" data-parent="0" data-type="add" data-rel="-1||<?php echo $_smarty_tpl->tpl_vars['profile']->value['id_profile'];?>
...
"<?php } else { ?> disabled="disabled"<?php }?>/>
                              ...
                              <th>
                                 <input type="checkbox" name="1" class="editall ajaxPower"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="2" data-parent="0" data-type="edit" data-rel="-1||<?php echo $_smarty_tpl->tpl_vars['profile']->value['id_profile'];?>
...
"<?php } else { ?> disabled="disabled"<?php }?>/>
                              ...
                              <th>
                                 <input type="checkbox" name="1" class="deleteall ajaxPower"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="3" data-parent="0" data-type="delete" data-rel="-1||<?php echo $_smarty_tpl->tpl_vars['profile']->value['id_profile'];?>
...
"<?php } else { ?> disabled="disabled"<?php }?>/>
                              ...
                              <th>
                                 <input type="checkbox" name="1" class="allall ajaxPower"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="4" data-parent="0" data-type="all" data-rel="-1||<?php echo $_smarty_tpl->tpl_vars['profile']->value['id_profile'];?>
...
"<?php if ($_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['tab']->value['id_tab']][$_smarty_tpl->tpl_vars['perm']->value]==1) {?> checked="checked"<?php }?>/>
                                    ...
                                    <?php } ?>
                                    <td>
                                       <input type="checkbox"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="4" data-parent="0" data-type="all" data-rel="<?php echo $_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['tab']->value['id_tab']]['id_tab'];?>
||<?php echo $_smarty_tpl->tpl_vars['profile']->value['id_profile'];?>
||all||<?php echo $_smarty_tpl->tpl_vars['tabsize']->value;?>
||<?php echo count($_smarty_tpl->tpl_vars['tabs']->value);?>
...
"<?php if ($_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['child']->value['id_tab']][$_smarty_tpl->tpl_vars['perm']->value]==1) {?> checked="checked"<?php }?>/>
                                                ...
                                                <?php } ?>
                                                <td>
                                                   <input type="checkbox"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="4" data-parent="<?php echo $_smarty_tpl->tpl_vars['child']->value['id_parent'];?>
...
"<?php if ($_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['subChild']->value['id_tab']][$_smarty_tpl->tpl_vars['perm']->value]==1) {?> checked="checked"<?php }?>/>
                                                         ...
                                                         <?php } else { ?>
                                                            <td>
                                                               <input type="checkbox" disabled="disabled"<?php if ($_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['subChild']->value['id_tab']][$_smarty_tpl->tpl_vars['perm']->value]==1) {?> checked="checked"<?php }?>/>
                                                            </td>
                                                         <?php }?>
                                                      ...
                                                      <?php } ?>
                                                      <td>
                                                         <input type="checkbox"<?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> data-id="4" data-parent="<?php echo $_smarty_tpl->tpl_vars['subChild']->value['id_parent'];?>
...
"<?php if ($_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['subsubChild']->value['id_tab']][$_smarty_tpl->tpl_vars['perm']->value]==1) {?> checked="checked"<?php }?>/>
                                                                  ...
                                                                  <?php } else { ?>
                                                                     <td>
                                                                        <input type="checkbox" disabled="disabled"<?php if ($_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['subsubChild']->value['id_tab']][$_smarty_tpl->tpl_vars['perm']->value]==1) {?> checked="checked"<?php }?>/>
                                                                     </td>
                                                                  <?php }?>
...
"<?php } else { ?> class="all <?php echo $_smarty_tpl->tpl_vars['access']->value[$_smarty_tpl->tpl_vars['subsubChild']->value['id_tab']]['id_tab'];?>
" disabled="disabled"<?php }?><?php if ($_smarty_tpl->tpl_vars['result_accesses']->value==4) {?> checked="checked"<?php }?>/>
                                                               </td>
                                                            </tr>
                                                         <?php }?>
